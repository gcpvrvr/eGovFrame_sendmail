                ...
                <form id="form2" name="form2" class="form-horizontal" method="post" action="">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10 control-label" style="text-align:left;">
                            ...
                            <input type="text" class="form-control" id="indate" name="indate" placeholder="작성일을 입력하세요" maxLength="10" style="float:left; width:40%" readonly value="${strToday }" pattern="yyyy-MM-dd hh:mm:ss">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="pwd">내용:</label>
