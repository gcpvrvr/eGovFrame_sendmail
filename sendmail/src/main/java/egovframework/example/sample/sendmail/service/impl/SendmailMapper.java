...
public interface SendmailMapper {
    ...
    * @exception Exception
    */
   void insertSendmail(SendmailVO vo) throws Exception;
    ...
    * @exception Exception
    */
   List<?> selectSendmailList(SendmailVO searchVO) throws Exception;
   ...
   int selectSendmailListTotCnt(SendmailVO searchVO);
   
   String selectLoginCheck(SendmailVO searchVO);
