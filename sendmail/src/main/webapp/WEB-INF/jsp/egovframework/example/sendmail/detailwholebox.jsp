...
<body id="page-top">
			...
			<div id="content">
				...
				<div class="container-fluid">
					<form class="form-horizontal" id="boardRegForm" name="boardRegForm"
						method="post" action="<c:url value='write.do'/>">
						<div
							class="d-sm-flex align-items-center justify-content-between mb-4">
							<h1 class="h3 mb-0 text-gray-800">메일 상세화면</h1>
						</div>
						<div>
							보낸 사람 <input type="text" class="form-control" value="${mailVO.sender }" readonly="readonly"
								id="senderAddress" name="senderAddress" placeholder="보낸 사람">
						</div>
						<br>
						<div>
							받는 사람 <input type="text" class="form-control" value="${mailVO.receiver }" readonly="readonly"
								id="receiverAddress" name="receiverAddress" placeholder="받는 사람">
						</div>
						<br>
						<div>
							제목 <input type="text" class="form-control" value="${mailVO.title }" readonly="readonly"
							id="title" name="title" placeholder="제목">
						</div>
						<br>
						<div>
							내용 <br>
							<textarea cols="30" rows="10" class="form-control" id="contents" readonly="readonly"
								name="contents" placeholder="내용">${mailVO.contents }</textarea>
						</div>
						<br>
	...
	function cancel(){
		location.href = "<c:url value='/wholebox.do'/>?userName=${userName }";
		}
	
	function mainBtn(){
		location.href = "<c:url value='/main.do'/>?userName=${userName }";
		}
		...
		<script
			src="<%=request.getContextPath()%>/css/bootstrap/js/demo/chart-area-demo.js"></script>
		<script
			src="<%=request.getContextPath()%>/css/bootstrap/js/demo/chart-pie-demo.js"></script>
</body>
